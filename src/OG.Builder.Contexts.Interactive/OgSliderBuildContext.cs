...
public class OgSliderBuildContext(IOgSlider<IOgVisualElement> element, OgTransformerRectGetter rectGetter, IDkObservableProperty<float> property,
    IDkObservable<float> observable)
    : OgValueBuildContext<IOgSlider<IOgVisualElement>, IOgVisualElement, OgTransformerRectGetter, float>(element, rectGetter, property, observable);
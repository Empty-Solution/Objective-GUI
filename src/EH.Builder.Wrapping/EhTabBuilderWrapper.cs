...
public class EhTabBuilderWrapper
{
    ...
    {
        m_MainWindowBuilder.TabButtons.Add(m_TabButtonBuilder.Build(buttonName, texture, m_MainWindowBuilder.TabSeparator!, m_MainWindowBuilder.TabContainer!,
            out IOgContainer<IOgElement> container));

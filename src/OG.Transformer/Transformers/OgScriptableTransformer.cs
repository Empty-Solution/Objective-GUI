...
{
    public delegate Rect TransformHandler(Rect               rect, Rect parentRect, Rect lastRect, int remaining,
    ...
    public override Rect Transform(Rect               rect, Rect parentRect, Rect lastRect, int remaining,
                                   OgScriptableOption option) => handler.Invoke(rect, parentRect, lastRect, remaining,
                                                                                option);
}
...
public class OgScrollFactory : IOgElementFactory<IOgScroll<IOgElement>, OgScrollFactoryArguments>
{
    public IOgScroll<IOgElement> Create(OgScrollFactoryArguments arguments) =>

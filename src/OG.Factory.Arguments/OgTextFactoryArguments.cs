...
public class OgTextFactoryArguments(string name, IDkGetProvider<Rect> rectGetProvider, IOgEventHandlerProvider? eventProvider,
    IDkGetProvider<Color> colorGetter, Font font, IDkGetProvider<int> fontSize, FontStyle fontStyle, IDkGetProvider<TextAnchor> alignment, TextClipping textClipping, bool wordWrap,

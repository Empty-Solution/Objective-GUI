...
public class OgTextureFactoryArguments(string name, IDkGetProvider<Rect> rectGetProvider, IOgEventHandlerProvider? eventProvider, Color? color,
    OgAnimationColorGetter<DkReadOnlyGetter<Color>>? colorGetter, Texture2D texture, Vector4 borderWidths, Vector4 borderRadiuses, float imageAspect,
    bool alphaBlend) : OgVisualFactoryArguments(name, rectGetProvider, eventProvider, color, colorGetter)
{

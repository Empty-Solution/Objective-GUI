...
public class OgTextureFactoryArguments(string name, IDkGetProvider<Rect> rectGetProvider, IOgEventHandlerProvider? eventProvider,
    IDkGetProvider<Color> colorGetter, IDkGetProvider<Texture2D> texture, IDkGetProvider<Vector4>? borderWidths, IDkGetProvider<Vector4>? borderRadiuses, float imageAspect, bool alphaBlend)

...
public class OgBindableFactoryArguments<TValue>(string name, IDkGetProvider<Rect> rectGetProvider, IOgEventHandlerProvider? eventProvider,
    IDkFieldProvider<TValue> value, IDkValueOverride<TValue> valueOverride, IDkProperty<KeyCode?> bind) : OgElementFactoryArguments(name, rectGetProvider, eventProvider)
{

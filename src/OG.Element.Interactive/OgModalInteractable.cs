...
public class OgModalInteractable<TElement> : OgHoverableElement<TElement>, IOgEventCallback<IOgMouseKeyDownEvent>, IOgEventCallback<IOgMouseKeyUpEvent>, IOgModalInteractable<TElement> where TElement : IOgElement
{
    private readonly bool m_RightClickOnly;
    public OgModalInteractable(string name, IOgEventHandlerProvider provider, IDkGetProvider<Rect> rectGetter, bool rightClickOnly) : base(name, provider, rectGetter)
    {

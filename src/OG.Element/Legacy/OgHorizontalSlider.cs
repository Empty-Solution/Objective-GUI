...
public class OgHorizontalSlider<TElement, TStyle, TScope>(string name, TStyle style, float value, IDkRange<float> range, TScope rootScope, IOgTransform transform)
    : OgSlider<TElement, TStyle, TScope>(name, style, value, range, rootScope, transform)

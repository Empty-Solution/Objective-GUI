...
public abstract class OgSlider<TElement, TStyle, TScope>(string name, TStyle style, float value, IDkRange<float> range, TScope rootScope, IOgTransform transform)
    : OgValueView<TElement, TStyle, TScope, float>(name, style, value, rootScope, transform)

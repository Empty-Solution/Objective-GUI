...
public class OgToggle<TElement, TStyle, TScope>(string name, TStyle style, bool value, TScope rootScope, IOgTransform transform)
    : OgValueView<TElement, TStyle, TScope, bool>(name, style, value, rootScope, transform)

...
public class OgVerticalSlider<TElement, TStyle, TScope>(string name, TStyle style, float value, IDkRange<float> range, TScope rootScope, IOgTransform transform)

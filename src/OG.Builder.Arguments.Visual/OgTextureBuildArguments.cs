...
public class OgTextureBuildArguments(string name, IDkGetProvider<Color> value, IOgEventHandlerProvider? provider, IDkGetProvider<Texture2D> texture,
    IDkGetProvider<Vector4>? borderWidths, IDkGetProvider<Vector4>? borderRadiuses, float imageAspect, bool alphaBlend)

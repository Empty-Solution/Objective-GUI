...
public abstract class OgDraggableValueView<TElement, TValue>(IOgEventProvider eventProvider)
    : OgValueView<TElement, TValue>(eventProvider) where TElement : IOgElement
{
    ...
    public override    bool   OnMouseMove(IOgMouseMoveEvent     reason) => base.OnMouseMove(reason) && UpdateValue(reason);
